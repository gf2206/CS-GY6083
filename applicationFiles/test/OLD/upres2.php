...
$sql = "update u778390814_FinalProj1.reservation  set source= ?, resDate = ?, checkInDate = ?, checkOutDate = ? where id_reservation = ?";
...
$stmt->bind_param("ssssi", $source, $resDate, $checkInDate, $checkOutDate, $id_reservation);
